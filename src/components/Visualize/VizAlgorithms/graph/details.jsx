    ...
    switch (this.props.algo) {
      ...
      case 1:
        return (
          <div className="row bg-info m-0 p-2 ">
            <div className="col-3  card me-1 bg-light">
              In mathematics, the binomial coefficients are the positive
              integers that occur as coefficients in the binomial theorem. It is
              the coefficient of the x^k term in the polynomial expansion of the
      ...
      case 2:
        return (
          <div className="row bg-info m-0 p-2 ">
            <div className="col-3  card me-1 bg-light ">
              In combinatorial mathematics, a derangement is a permutation of
              the elements of a set, such that no element appears in its
              original position.
            </div>
            <div className="col-3  card me-1 bg-light ">
              N = Nth Derangement
        ...
        return (
          <div className="row bg-info m-0 p-2 ">
            <div className="col-3  card me-1 bg-light ">
              ...
              number) is the number of ways to partition a set of n objects into
              k non-empty subsets
            </div>
